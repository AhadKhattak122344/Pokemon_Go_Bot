...
public class FloatingMenuService extends Service implements View.OnClickListener{
    ...
    private final BroadcastReceiver screenReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (Intent.ACTION_SCREEN_OFF.equals(intent.getAction())) {
                if (fragment != null) fragment.updateClient(false);
                else stopSelf();
            }
        }
    };
    ...
    public void onDestroy() {
        ...
        super.onDestroy();
        if (mWindowManager != null && myFloatingView != null && myFloatingView.isAttachedToWindow()) {
