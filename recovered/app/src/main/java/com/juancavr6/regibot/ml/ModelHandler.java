...
public class ModelHandler {
    ...
    public static class Predictor implements AutoCloseable {
    ...
    public static class Classifier implements AutoCloseable {
        ...
        @Override
        public void close() { imageClassifier.close(); }
